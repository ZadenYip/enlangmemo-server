...
-- ARGV[3] = ttl seconds
--
-- return {1, sync_cursor_usn, server_sync_cursor_usn_at_handshake}: 校验成功，并推进了 batch_seq
...
if sessionID == false or state == nil or expectedBatchSeq == nil or syncCursorUSN == nil or serverSyncCursorUSNAtHandshake == nil or curBatchSeq == nil then
  return {2, 0, 0}
end
...
return {1, syncCursorUSN, serverSyncCursorUSNAtHandshake}
